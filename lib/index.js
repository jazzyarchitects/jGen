  ...
  // },
    {
      ...
      message: "Should use key based API authentication?",
      default: false
    }])
...
let __showModels = function () {
  ...
  let name = global.npmconfig.name;
  let spaceString = "";
...
// let log = global.color ? chalk[global.color] : chalk.blue;
let logBold = global.color ? chalk[global.color].bold : chalk.cyan.bold;
