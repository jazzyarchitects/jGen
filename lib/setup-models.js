...
function done(){
  createModels(__answers, __answers.baseModel)
    .then(function(){
      ...
      console.log(chalk.yellow("You can edit the model properties by modifying /modules/"+__answers.baseModel+"/models/"+__answers.baseModel+".js"));
      console.log(chalk.yellow("Refer http://mongoosejs.com/docs/schematypes.html for information on defining Schema properties"));
      process.exit(0);
    });
}
