...
function done(){
  ...
  .then(function(){
    console.log(chalk.green("Finished creating model: "+__answers.modelName));
    console.log(chalk.blue("You can edit this model properties by modifying /modules/"+__answers.modelName+"/models/"+__answers.modelName+".js"));
    console.log(chalk.blue("Refer "+chalk.bold("http://mongoosejs.com/docs/schematypes.html")+" for information on defining Schema properties"));
    process.exit(0);
  });
}
