...
module.exports = function(app){
  ...
  {{#if jgenConfig.apiAuthentication}}
  if(!app.get('accessKeys')){
    throw new Error("Define accessKeys in config files");
  }
  apiRouter.use(apiAuthentication(app.get('accessKeys')));
  {{/if}}
